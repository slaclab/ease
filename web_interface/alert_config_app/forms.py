...
class configTrigger(forms.Form):
    ...
    :param noodle: Definately a noodle, rice will not do
    :type noodle: str
    configTrigger sets only a few fields 

    Note that fields referencing databse entries (e.g. new_pv's use of 
    PV.objects.all()) MUST be placed inside the init funciton. Failure to do
